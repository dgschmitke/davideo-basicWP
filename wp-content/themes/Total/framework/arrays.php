...
function wpex_social_button_styles() {
	return apply_filters( 'wpex_social_button_styles', array(
		...
		'black-ch'           => esc_html_x( 'Black with Color Hover', 'Social Button Style', 'total' ),
		'black-ch-rounded'   => esc_html_x( 'Black with Color Hover Rounded', 'Social Button Style', 'total' ),
		'black-ch-round'     => esc_html_x( 'Black with Color Hover Round', 'Social Button Style', 'total' ),
