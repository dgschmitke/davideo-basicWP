...
function wpex_theme_hooks() {
	return array(
		'outer_wrap' => array(
			'label' => esc_html_x( 'Outer Wrap', 'Theme Hook Section Label', 'total' ),
			'hooks' => array(
		...
		'wrap' => array(
			'label' => esc_html_x( 'Wrap', 'Theme Hook Location', 'total' ),
			'hooks' => array(
		...
		'topbar' => array(
			'label' => esc_html_x( 'Top Bar', 'Theme Hook Location', 'total' ),
			'hooks' => array(
		...
		'header' => array(
			'label' => esc_html_x( 'Header', 'Theme Hook Location', 'total' ),
			'hooks' => array(
		...
		'main_menu' => array(
			'label' => esc_html_x( 'Main Menu', 'Theme Hook Location', 'total' ),
			'hooks' => array(
		...
		'main' => array(
			'label' => esc_html_x( 'Main', 'Theme Hook Location', 'total' ),
			'hooks' => array(
		...
		'primary' => array(
			'label' => esc_html_x( 'Primary Wrap', 'Theme Hook Location', 'total' ),
			'hooks' => array(
		...
		'content' => array(
			'label' => esc_html_x( 'Content Wrap', 'Theme Hook Location', 'total' ),
			'hooks' => array(
		...
		'sidebar' => array(
			'label' => esc_html_x( 'Sidebar', 'Theme Hook Location', 'total' ),
			'hooks' => array(
		...
		'footer' => array(
			'label' => esc_html_x( 'Footer', 'Theme Hook Location', 'total' ),
			'hooks' => array(
		...
		'page_header' => array(
			'label' => esc_html_x( 'Page Header', 'Theme Hook Location', 'total' ),
			'hooks' => array(
		...
		'social_share' => array(
			'label' => esc_html_x( 'Social Share', 'Theme Hook Location', 'total' ),
			'hooks' => array(
