		...
		<div class="wpex-sortable">
			...
			<ul id="<?php echo $this->id; ?>_sortable">
				...
				foreach ( $choices as $val => $label ) {
					...
					<li data-value="<?php echo esc_attr( $val ); ?>" class="wpex-sortable-li<?php echo esc_attr( $hide_sortee ); ?>">
						<?php echo strip_tags( $label ); ?>
						<span class="wpex-hide-sortee dashicons <?php echo esc_attr( $hide_icon ); ?>"></span>
					</li>
				<?php } ?>
			</ul>
		</div><!-- .wpex-sortable -->
