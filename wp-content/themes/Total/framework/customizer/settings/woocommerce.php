	...
	'settings' => array(
		...
		array(
			...
			'control' => array (
				...
				'desc' => esc_html__( 'You must save your options and refresh your live site to preview changes to this setting. You may have to also add or remove an item from the cart to clear the WooCommerce cache.', 'total' ),
			),
		),
		array(
			...
			'control' => array (
				...
				'active_callback' => 'wpex_cac_has_menu_cart',
			),
		),
		array(
