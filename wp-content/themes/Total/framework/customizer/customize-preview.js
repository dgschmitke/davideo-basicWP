	...
	/******** General *********/
		...
		api('social_share_position', function( value ) {
			value.bind( function( newval ) {
				...
				$( '.wpex-social-share-wrap, .wpex-social-share' ).removeClass( 'position-horizontal position-vertical' );
				$( '.wpex-social-share-wrap, .wpex-social-share' ).addClass( 'position-'+ newval );
			});
		});

		api('social_share_style', function( value ) {
			value.bind( function( newval ) {
				$( '.wpex-social-share' ).removeClass( 'style-rounded style-minimal style-flat style-three-d' );
				$( '.wpex-social-share' ).addClass( 'style-'+ newval );
			});
		});

		api('scroll_top_arrow', function( value ) {
			value.bind( function( newval ) {
				$( '#site-scroll-top > span' ).removeClass();
				$( '#site-scroll-top > span' ).addClass( 'fa' );
				$( '#site-scroll-top > span' ).addClass( 'fa-'+ newval );
			});
		});
