...
class WPEX_Staff_Config {
	...
	public function __construct() {
		...
		if ( 'off' != wpex_get_mod( 'staff_tags', 'on' ) ) {
			add_action( 'init', array( $this, 'register_tags' ), 0 );
		}
		if ( 'off' != wpex_get_mod( 'staff_categories', 'on' ) ) {
				...
				<table class="form-table">
					<tr valign="top">
						...
						<td>
							...
							<input type="hidden" name="wpex_staff_branding[staff_admin_icon]" id="wpex-dashicon-select-input" value="<?php echo esc_attr( $mod ); ?>"></td>
						</td>
					</tr>
					<tr valign="top">
					...
					<tr valign="top" id="wpex-tags-enable">
						...
						<td><input type="checkbox" name="wpex_staff_branding[staff_tags]" value="<?php echo esc_attr( $mod ); ?>" <?php checked( $mod, 'on' ); ?> /></td>
					</tr>
					...
					<tr valign="top" id="wpex-categories-enable">
						...
						$mod = 'off' != $mod ? 'on' : 'off'; // sanitize ?>
						<td><input type="checkbox" name="wpex_staff_branding[staff_categories]" value="<?php echo esc_attr( $mod ); ?>" <?php checked( $mod, 'on' ); ?> /></td>
					</tr>
